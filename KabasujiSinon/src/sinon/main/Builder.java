...
public class Builder extends Kabasuji {
	...
	public void initializeMainView() {
		...
		mv.getBullpenView().contentPanel
		.addMouseListener(new BullpenController(this.getLevel()
				.getBullpen(), mv.getBullpenView(), currentLevel));
	...
	public void registerBoardViewControllers() {
		...
		for (TileView t : tileViews) {
			/*
			 * t.addMouseListener(new BuilderTileController(t,
			 * this.currentLevel, this.mainView.getBoardView()));
			 */
		}
