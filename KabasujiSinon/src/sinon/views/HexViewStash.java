...
public class HexViewStash implements Observer {
	...
	/**
	 * @return The HexominoBullpenViews contained by this HexViewStash.
	 */
	...
	private void validateHexominoListState() {
		...
		if (hexViewSize != bullpenSize) {
			throw new IllegalStateException("Different number of hexominos in bullpen and bullpenview.");
		}
