...
public class PlayerView extends JPanel {
    ...
    public void initialize() {
        ...
        // ------
        // JPanel InteractionsView = createInteractionsView();

        /*
         * JPanel LevelView = new JPanel(); LevelView.setPreferredSize(new
         * Dimension(605, 10)); LevelView.setBorder(new LineBorder(new Color(0,
         * 0, 0))); this.add(LevelView, BorderLayout.WEST);
         * LevelView.setLayout(new BorderLayout(0, 0));
         * 
         * JPanel Bullpen = new JPanel(); Bullpen.setPreferredSize(new
         * Dimension(10, 180)); LevelView.add(Bullpen, BorderLayout.NORTH);
         * Bullpen.setLayout(null);
         * 
         * JButton btnNewButton_1 = new JButton("");
         * btnNewButton_1.setBounds(22, 6, 150, 149);
         * Bullpen.add(btnNewButton_1);
         * 
         * JScrollBar scrollBar = new JScrollBar(); scrollBar.setBorder(new
         * LineBorder(new Color(0, 0, 0)));
         * scrollBar.setOrientation(JScrollBar.HORIZONTAL);
         * scrollBar.setBounds(0, 163, 603, 17); Bullpen.add(scrollBar);
         * 
         * JPanel BoardView = new JPanel(); BoardView.setPreferredSize(new
         * Dimension(10, 300)); LevelView.add(BoardView, BorderLayout.CENTER);
         * BoardView.setLayout(null);
         * 
         * JButton btnNewButton_2 = new JButton("12x12 Board\r\n");
         * btnNewButton_2.setBounds(141, 26, 300, 298);
         ...
         * Font("Gotham Light", Font.BOLD, 20)); btnExit.setBounds(25, 154, 130,
         * 98); InteractionsView.add(btnExit);
         * 
         * PlayerView current = this; btnExit.addActionListener(new
         * ActionListener() { public void
         * actionPerformed(java.awt.event.ActionEvent evt) {
         * game.startNextPanel(current, new LevelSelectView(game)); } });
         * 
         * JButton btnNextLevel = new JButton("Next Level\r\n");
         * btnNextLevel.setEnabled(false); btnNextLevel.setFont(new
         * Font("Gotham Light", Font.BOLD, 14)); btnNextLevel.setBounds(25, 285,
         * 130, 98); InteractionsView.add(btnNextLevel);
         * 
