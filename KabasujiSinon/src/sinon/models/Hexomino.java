...
public class Hexomino implements Serializable {
	 ...
	 */
	public Hexomino(int a, int a1, int b, int b1, int c, int c1, int d, int d1, int e, int e1, int f, int f1) {

		this.hexominoNumberSet = new HexominoNumberSet(a, a1, b, b1, c, c1, d, d1, e, e1, f, f1);
