...
public class HexominoTest {
	...
	@Test
	public void testDifferentHexominos() {
		// Test that two hexominos are not equals
		Hexomino h1 = Hexomino.getExampleHexomino();
		Hexomino h2 = Hexomino.getExampleHexomino();

		assertFalse(h1.equals(h2));
		LinkedList<Hexomino> list = new LinkedList<Hexomino>();
		list.add(h1);
		list.add(h2);
		BullPen bp = new BullPen(list);
		assertTrue(bp.containsHexID(h1.getID()));
		assertTrue(bp.containsHexID(h2.getID()));
		bp.removeHexomino(h1);
		assertFalse(bp.containsHexID(h1.getID()));
		assertTrue(bp.containsHexID(h2.getID()));
	}
